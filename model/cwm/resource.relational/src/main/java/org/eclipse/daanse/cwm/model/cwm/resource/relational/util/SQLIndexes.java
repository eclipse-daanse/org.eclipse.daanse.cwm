...
public final class SQLIndexes {
    ...
    /**
     * SQLIndexes whose {@code spannedClass} is {@code table}, wherever they are
     * owned. Reverse navigation — see {@link InverseReferences} for the index it
     * needs.
     */
    ...
    public static Stream<SQLIndex> spanningStream(Table table) {
        return InverseReferences.referencing(table, KeysindexesPackage.Literals.INDEX__SPANNED_CLASS, SQLIndex.class);
    }
